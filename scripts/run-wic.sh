...
# hyperparameters
# WiC: 1 epoch consists of 170 batches of 32 examples
ARCH=${ARCH:-"roberta_large"}
LR=${LR:-"1e-5"}
MAX_EPOCH=${MAX_EPOCH:-50}
TOTAL_NUM_UPDATES=${TOTAL_NUM_UPDATES:-8500}
WARMUP_UPDATES=${WARMUP_UPDATES:-850}
MAX_SENTENCES=${MAX_SENTENCES:-16}
